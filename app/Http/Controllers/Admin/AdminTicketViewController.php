...
class AdminTicketViewController extends Controller
{
    public function customerprevioustickets($cust_id)
    {
        ...
        $active = Ticket::where('cust_id', $cust_id)->active()->get();
       $data['active'] = $active;
    ...
    public function allactiveassignedtickets()
    {
        ...
        $allactiveassignedtickets = Ticket::active()->leftjoin('ticketassignchildren', 'ticketassignchildren.ticket_id', 'tickets.id')->where(function($r){
