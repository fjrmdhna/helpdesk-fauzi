								...
								<div class="card ">
									...
									<div class="card-body overflow-scroll">
										<div class="spruko-delete">
											...
											@endcan
											<button id="exportExcel" class="btn btn-outline-success btn-sm mb-4 data-table-btn" data-bs-toggle="tooltip" data-bs-placement="top" title="{{lang('Export to Excel')}}"><i class="fe fe-download"></i> {{lang('Export to Excel')}}</button>
