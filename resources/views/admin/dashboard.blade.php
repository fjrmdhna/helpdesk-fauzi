@extends('layouts.adminmaster')
		...
		@endsection
							...
							<h6 class="fw-semibold mb-3">{{lang('Global Tickets', 'menu')}}</h6>
							@include('includes.admin.dashboard-global-ticket-cards')

							<h6 class="fw-semibold mb-3">{{lang('Self Tickets')}}</h6>
							<div class="row">
										...
										<div class="card-body overflow-scroll">
											<div class="">
												<div class="data-table-btn">
													...
													@endcan
													<button id="exportExcel" class="btn btn-outline-success btn-sm mb-4" data-bs-toggle="tooltip" data-bs-placement="top" title="{{lang('Export to Excel')}}"><i class="fe fe-download"></i> <span>{{lang('Export to Excel')}}</span></button>
