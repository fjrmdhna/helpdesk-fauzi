		...
		<div class="card-body" >
			<div class="table-responsive spruko-delete">
				<div class="data-table-btn">
					...
					@endcan
					<button id="exportExcel" class="btn btn-outline-success btn-sm mb-4 ticketdeleterow" data-bs-toggle="tooltip" data-bs-placement="top" title="{{lang('Export to Excel')}}"><i class="fe fe-download"></i> {{lang('Export to Excel')}}</button>
