                            ...
                            <div class="card-body status">
                                ...
                                <div class="form-group">
                                    <div class="custom-controls-stacked d-md-flex" id="text">
                                        ...
                                        <label class="custom-control form-radio success me-4">
                                        <input type="radio" class="custom-control-input hold sprukostatuschange" name="status" id="closed" value="Solved" @if(old('status') == 'Solved') checked @endif>
                                    ...
                                    <div class="mt-3 js-closed-reason-wrapper {{ old('status') === 'Solved' ? '' : 'd-none' }}" data-trigger-status="Solved">
