                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr {{$onholdticket->replystatus == 'Waiting'? 'class=bg-success-transparent': ''}}>
                                            ...
                                            <td>
                                                    {{$onholdticket->created_at->timezone(Auth::user()->timezone)->format(setting('date_format'))}}
                                                </td>
                                                <td>
                                                    @if($onholdticket->closing_ticket != null)
                                                        {{$onholdticket->closing_ticket->timezone(Auth::user()->timezone)->format(setting('date_format'))}}
                                                    @else
                                                ...
                                                <td>
                                                    @php
                                                        $endDate = $onholdticket->closing_ticket ?? now();
                                                        $duration = $onholdticket->created_at->diffInHours($endDate);
                                                ...
                                                <td class="text-muted">
                                                    {{ $onholdticket->customFieldValue('Location') ?? '~' }}
                                                </td>
                                                <td class="text-muted">
                                                    {{ $onholdticket->customFieldValue('EOS Indication') ?? '~' }}
                                                </td>
                                                <td class="text-muted">
                                                    {{ $onholdticket->lastReplyText(90) ?? '~' }}
                                                </td>
                                                <td>
