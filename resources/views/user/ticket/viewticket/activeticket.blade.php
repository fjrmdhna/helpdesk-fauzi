                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($activetickets as $activeticket)
                                            <tr {{$activeticket->replystatus == 'Waiting'? 'class=bg-success-transparent': ''}}>
                                                ...
                                                <td>
                                                    {{$activeticket->created_at->timezone(Auth::user()->timezone)->format(setting('date_format'))}}
                                                </td>
                                                <td>
                                                    @if($activeticket->closing_ticket != null)
                                                        {{$activeticket->closing_ticket->timezone(Auth::user()->timezone)->format(setting('date_format'))}}
                                                    @else
                                                ...
                                                <td>
                                                    @php
                                                        $endDate = $activeticket->closing_ticket ?? now();
                                                        $duration = $activeticket->created_at->diffInHours($endDate);
                                                ...
                                                <td class="text-muted">
                                                    {{ $activeticket->customFieldValue('Location') ?? '~' }}
                                                </td>
                                                <td class="text-muted">
                                                    {{ $activeticket->customFieldValue('EOS Indication') ?? '~' }}
                                                </td>
                                                <td class="text-muted">
                                                    {{ $activeticket->lastReplyText(90) ?? '~' }}
                                                </td>
                                                <td>
