                                        ...
                                        <table class="table table-bordered border-bottom text-nowrap ticketdeleterow w-100"
                                            ...
                                            <tbody>
                                                ...
                                                <tr {{$ticket->replystatus == 'Waiting'? 'class=bg-success-transparent': ''}}>
                                                    ...
                                                    <td>
                                                        {{$ticket->created_at->timezone(Auth::user()->timezone)->format(setting('date_format'))}}
                                                    </td>
                                                    <td>
                                                        @if($ticket->closing_ticket != null)
                                                            {{$ticket->closing_ticket->timezone(Auth::user()->timezone)->format(setting('date_format'))}}
                                                        @else
                                                    ...
                                                    <td class="text-muted">
                                                        {{ $ticket->customFieldValue('Location') ?? '~' }}
                                                    </td>
                                                    <td class="text-muted">
                                                        {{ $ticket->customFieldValue('EOS Indication') ?? '~' }}
                                                    </td>
                                                    <td class="text-muted">
                                                        {{ $ticket->lastReplyText(90) ?? '~' }}
                                                    </td>
                                                    <td>
